...
const models: TsoaRoute.Models = {
    ...
    "Driver": {
        ...
        "properties": {
            ...
            "secondNationalityCountryId": {"dataType":"union","subSchemas":[{"dataType":"string"},{"dataType":"enum","enums":[null]}],"required":true},
    ...
    "LapQueryParams": {
        "dataType": "refObject",
        "properties": {
            "pageNo": {"dataType":"union","subSchemas":[{"dataType":"double"},{"dataType":"string"}],"default":"0"},
            "pageSize": {"dataType":"union","subSchemas":[{"dataType":"double"},{"dataType":"string"}],"default":"10"},
            "orderDir": {"ref":"OrderDir","default":"ASC"},
            "raceId": {"dataType":"string"},
            "driverId": {"dataType":"string"},
            "year": {"dataType":"double"},
            "pos": {"dataType":"double"},
            "orderBy": {"dataType":"enum","enums":["raceId","driverId","pos","time","lap"],"default":"raceId"},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
