  ...
  CompanyQueryParams: {
    ...
    properties: {
      ...
      specialty: {
        dataType: 'union',
        subSchemas: [
          { dataType: 'enum', enums: ['engine'] },
          { dataType: 'enum', enums: ['chassis'] }
        ]
      }
    },
    additionalProperties: false
...
export function RegisterRoutes(app: Router) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      DriverService.prototype.getDriverSeasons
    ),

    function DriverService_getDriverSeasons(
      request: any,
      response: any,
      next: any
    ) {
      const args = {
        ...
        from: {
          ...
          dataType: 'union',
          subSchemas: [
            { dataType: 'enum', enums: ['entrants'] },
            { dataType: 'enum', enums: ['races'] }
          ]
        }
      };
      ...
      try {
        ...
        const promise = controller.getDriverSeasons.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(DriverService),
    ...fetchMiddlewares<RequestHandler>(
      DriverService.prototype.getChampionshipResults
    ),

    function DriverService_getChampionshipResults(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getChampionshipResults.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      FreePracticeResultService.prototype.getSessionsResults
    ),

    function FreePracticeService_getSessionsResults(
      request: any,
      response: any,
      next: any
    ) {
      const args = {
        session: {
          ...
          dataType: 'union',
          subSchemas: [
            { dataType: 'enum', enums: ['fp1'] },
            { dataType: 'enum', enums: ['fp2'] },
            { dataType: 'enum', enums: ['fp3'] },
            { dataType: 'enum', enums: ['fp4'] },
            { dataType: 'enum', enums: ['warm-up'] }
          ]
        },
        filters: {
          in: 'queries',
          name: 'filters',
          required: true,
          ref: 'TimedSessionResultQueryParams'
        }
      };
      ...
      try {
        ...
        const promise = controller.getSessionsResults.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(FreePracticeResultService),
    ...fetchMiddlewares<RequestHandler>(
      FreePracticeResultService.prototype.getSessionResults
    ),

    function FreePracticeService_getSessionResults(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getSessionResults.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(FreePracticeResultService),
    ...fetchMiddlewares<RequestHandler>(
      FreePracticeResultService.prototype.getDriverSessionResult
    ),

    function FreePracticeService_getDriverSessionResult(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getDriverSessionResult.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(LapService),
    ...fetchMiddlewares<RequestHandler>(
      LapService.prototype.getEventFastestLap
    ),

    function LapService_getEventFastestLap(
      request: any,
      response: any,
      next: any
    ) {
  ...
  app.get(
    ...
    function PitStopService_getPitStops(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getPitStops.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    function TyreManufacturerService_get(
      request: any,
      response: any,
      next: any
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(TyreManufacturerService),
    ...fetchMiddlewares<RequestHandler>(
      TyreManufacturerService.prototype.getById
    ),

    function TyreManufacturerService_getById(
      request: any,
      response: any,
      next: any
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      EventEntrantService.prototype.getEventEntrants
    ),

    function EventEntrantService_getEventEntrants(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getEventEntrants.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      RaceResultService.prototype.getRacesResults
    ),

    function RaceResultService_getRacesResults(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getRacesResults.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(RaceResultService),
    ...fetchMiddlewares<RequestHandler>(
      RaceResultService.prototype.getRaceResults
    ),

    function RaceResultService_getRaceResults(
      request: any,
      response: any,
      next: any
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(RaceResultService),
    ...fetchMiddlewares<RequestHandler>(
      RaceResultService.prototype.getDriverRaceResult
    ),

    function RaceResultService_getDriverRaceResult(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getDriverRaceResult.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      DriverStandingService.prototype.getDriverChampionshipResults
    ),

    function DriverStandingService_getDriverChampionshipResults(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getDriverChampionshipResults.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(DriverStandingService),
    ...fetchMiddlewares<RequestHandler>(
      DriverStandingService.prototype.getDriverChampionshipResult
    ),

    function DriverStandingService_getDriverChampionshipResult(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getDriverChampionshipResult.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      PreQualifyingResultService.prototype.getPreQualifyingsResults
    ),

    function PreQualifyingResultService_getPreQualifyingsResults(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getPreQualifyingsResults.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(PreQualifyingResultService),
    ...fetchMiddlewares<RequestHandler>(
      PreQualifyingResultService.prototype.getSessionResults
    ),

    function PreQualifyingResultService_getSessionResults(
      request: any,
      response: any,
      next: any
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(PreQualifyingResultService),
    ...fetchMiddlewares<RequestHandler>(
      PreQualifyingResultService.prototype.getDriverSessionResult
    ),

    function PreQualifyingResultService_getDriverSessionResult(
      request: any,
      response: any,
      next: any
    ) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      sprintQualifyingResultService.prototype.getSprintQualifyingsResults
    ),

    function sprintQualifyingResultService_getSprintQualifyingsResults(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getSprintQualifyingsResults.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(sprintQualifyingResultService),
    ...fetchMiddlewares<RequestHandler>(
      sprintQualifyingResultService.prototype.getSprintQualifyingResults
    ),

    function sprintQualifyingResultService_getSprintQualifyingResults(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const promise = controller.getSprintQualifyingResults.apply(
          controller,
          validatedArgs as any
        );
        promiseHandler(controller, promise, response, undefined, next);
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(sprintQualifyingResultService),
    ...fetchMiddlewares<RequestHandler>(
      sprintQualifyingResultService.prototype.getDriverRaceResult
    ),

    function sprintQualifyingResultService_getDriverRaceResult(
      request: any,
      response: any,
      next: any
    ) {
